...
define i32 @test_direct_call() #0 {
  %tmp0 = call i32 ptrauth(ptr @f, i32 0, ptr null, i64 42)() [ "ptrauth"(i32 0, i64 42) ]
  ret i32 %tmp0
}
...
define i32 @test_direct_call_mismatch() #0 {
  %tmp0 = call i32 ptrauth(ptr @f, i32 0, ptr null, i64 42)() [ "ptrauth"(i32 1, i64 42) ]
  ret i32 %tmp0
}
...
define i32 @test_direct_call_addr() #0 {
  %tmp0 = call i32 ptrauth(ptr @f, i32 1, ptr @f.ref.ib.0.addr, i64 0)() [ "ptrauth"(i32 1, i64 ptrtoint (ptr @f.ref.ib.0.addr to i64)) ]
  ret i32 %tmp0
}
...
define i32 @test_direct_call_addr_blend() #0 {
  ...
  %tmp1 = call i32 ptrauth(ptr @f, i32 1, ptr @f.ref.ib.42.addr, i64 42)() [ "ptrauth"(i32 1, i64 %tmp0) ]
  ret i32 %tmp1
}
...
define i32 @test_direct_call_addr_gep_different_index_types() #0 {
  %tmp0 = call i32 ptrauth(ptr @f, i32 1, ptr getelementptr ({ ptr }, ptr @f_struct.ref.ib.0.addr, i64 0, i32 0), i64 0)() [ "ptrauth"(i32 1, i64 ptrtoint (ptr getelementptr ({ ptr }, ptr @f_struct.ref.ib.0.addr, i32 0, i32 0) to i64)) ]
  ret i32 %tmp0
}
...
define i32 @test_direct_call_addr_blend_gep_different_index_types() #0 {
  ...
  %tmp1 = call i32 ptrauth(ptr @f, i32 1, ptr getelementptr ({ ptr }, ptr @f_struct.ref.ib.123.addr, i64 0, i32 0), i64 123)() [ "ptrauth"(i32 1, i64 %tmp0) ]
  ret i32 %tmp1
}
...
@f.ref.ib.42.addr = constant ptr ptrauth(ptr @f, i32 1, ptr @f.ref.ib.42.addr, i64 42)
...
@f.ref.ib.0.addr = constant ptr ptrauth(ptr @f, i32 1, ptr @f.ref.ib.0.addr, i64 0)
...
@f_struct.ref.ib.0.addr = constant { ptr } { ptr ptrauth(ptr @f, i32 1, ptr getelementptr ({ ptr }, ptr @f_struct.ref.ib.0.addr, i64 0, i32 0), i64 0) }
...
@f_struct.ref.ib.123.addr = constant { ptr } { ptr ptrauth(ptr @f, i32 1, ptr getelementptr ({ ptr }, ptr @f_struct.ref.ib.0.addr, i64 0, i32 0), i64 123) }
