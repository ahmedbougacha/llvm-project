...
define void @f() "ptrauth-calls" presplitcoroutine {
entry:
...
; CHECK-NEXT:   %[[NEXT_HDL_I64:.+]] = ptrtoint ptr %[[NEXT_HDL]] to i64
; CHECK-NEXT:   %[[CONT_DISC:.+]] = call i64 @llvm.ptrauth.blend(i64 %[[NEXT_HDL_I64]], i64 22017)
; CHECK-NEXT:   musttail call {{.*}} void %[[CONT]](ptr %[[NEXT_HDL]]) [ "ptrauth"(i32 0, i64 %[[CONT_DISC]]) ]
step2:
