...
;
  %authed = call i64 @llvm.ptrauth.auth(i64 ptrtoint(ptr ptrauth(ptr @foo, i32 1, ptr null, i64 1234) to i64), i32 1, i64 1234)
  ret i64 %authed
}
...
;
  ...
  %authed = call i64 @llvm.ptrauth.auth(i64 ptrtoint(ptr ptrauth(ptr @foo, i32 1, ptr @foo, i64 1234) to i64), i32 1, i64 %blended)
  ret i64 %authed
}
...
; CHECK-NEXT:    [[AUTHED:%.*]] = call i64 @llvm.ptrauth.auth(i64 ptrtoint (ptr ptrauth (ptr @foo, i32 1, ptr null, i64 1234) to i64), i32 1, i64 12)
; CHECK-NEXT:    ret i64 [[AUTHED]]
;
  %authed = call i64 @llvm.ptrauth.auth(i64 ptrtoint(ptr ptrauth(ptr @foo, i32 1, ptr null, i64 1234) to i64), i32 1, i64 12)
  ret i64 %authed
}

define i64 @test_ptrauth_nop_global_mismatch_key() {
; CHECK-LABEL: @test_ptrauth_nop_global_mismatch_key(
; CHECK-NEXT:    [[AUTHED:%.*]] = call i64 @llvm.ptrauth.auth(i64 ptrtoint (ptr ptrauth (ptr @foo, i32 1, ptr null, i64 1234) to i64), i32 0, i64 1234)
; CHECK-NEXT:    ret i64 [[AUTHED]]
;
  %authed = call i64 @llvm.ptrauth.auth(i64 ptrtoint(ptr ptrauth(ptr @foo, i32 1, ptr null, i64 1234) to i64), i32 0, i64 1234)
  ret i64 %authed
}
...
; CHECK-NEXT:    ret i64 ptrtoint (ptr ptrauth (ptr @foo, i32 0, ptr null, i64 42) to i64)
;

  %tmp0 = ptrtoint ptr %p to i64
  %authed = call i64 @llvm.ptrauth.resign(i64 ptrtoint(ptr ptrauth(ptr @foo, i32 1, ptr null, i64 1234) to i64), i32 1, i64 1234, i32 0, i64 42)
  ret i64 %authed
}
