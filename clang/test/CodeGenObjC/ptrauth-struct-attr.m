...
// CHECK: @gp0 = global ptr ptrauth (ptr @g0, i32 1, i64 100), align 8
// CHECK: @gp1 = global ptr ptrauth (ptr getelementptr (i8, ptr @g1, i64 24), i32 1, i64 100), align 8
...
// CHECK: %[[S0:.*]] = getelementptr inbounds nuw %[[STRUCT_S1]], ptr %[[T1]], i32 0, i32 2
...
// CHECK: %[[A1:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[ARRAYIDX4]], i32 0, i32 1
...
// CHECK: %[[A0:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[T0]], i32 0, i32 0
// CHECK: %[[V1:.*]] = load i32, ptr %[[A0]], align 4
// CHECK: %[[A1:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[T0]], i32 0, i32 1
...
// CHECK: %[[BLOCK_CAPTURED:.*]] = getelementptr inbounds nuw <{ ptr, i32, i32, ptr, ptr, ptr, %[[STRUCT_S0]] }>, ptr %[[BLOCK]], i32 0, i32 5
// CHECK: %[[V4:.*]] = load ptr, ptr %[[S_ADDR]], align 8
// CHECK: store ptr %[[V4]], ptr %[[BLOCK_CAPTURED]], align 8
// CHECK: %[[BLOCK_CAPTURED1:.*]] = getelementptr inbounds nuw <{ ptr, i32, i32, ptr, ptr, ptr, %[[STRUCT_S0]] }>, ptr %[[BLOCK]], i32 0, i32 6
...
// CHECK: %[[BLOCK_CAPTURE_ADDR:.*]] = getelementptr inbounds nuw <{ ptr, i32, i32, ptr, ptr, ptr, %[[STRUCT_S0]] }>, ptr %[[_BLOCK_DESCRIPTOR]], i32 0, i32 5
...
// CHECK: %[[BLOCK_CAPTURE_ADDR1:.*]] = getelementptr inbounds nuw <{ ptr, i32, i32, ptr, ptr, ptr, %[[STRUCT_S0]] }>, ptr %[[_BLOCK_DESCRIPTOR]], i32 0, i32 6
// CHECK: %[[A1:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[BLOCK_CAPTURE_ADDR1]], i32 0, i32 1
...
// CHECK: %[[A1:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[V9]], i32 0, i32 1
// CHECK: load i32, ptr %[[A1]], align 4
