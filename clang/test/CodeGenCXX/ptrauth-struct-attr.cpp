...
// CHECK: @gs2 = constant ptr ptrauth (ptr @gs0, i32 1, i64 100), align 8
// CHECK: @gs3 = constant ptr ptrauth (ptr @gs0, i32 1, i64 100), align 8
...
// CHECK: @gs9 = global ptr ptrauth (ptr @gs8, i32 1, i64 100), align 8
// CHECK: @gs10 = global %[[STRUCT_S8]] zeroinitializer, align 1
// CHECK: @gs11 = global ptr ptrauth (ptr @gs10, i32 1, i64 200), align 8
// CHECK: @gs12 = global %[[STRUCT_S9]] zeroinitializer, align 1
// CHECK: @gs13 = global ptr ptrauth (ptr @gs12, i32 0, i64 202), align 8
// CHECK: @gs16 = global %[[STRUCT_S12]] zeroinitializer, align 1
// CHECK: @gs17 = global ptr ptrauth (ptr @gs16, i32 2, i64 102), align 8
// CHECK: @gs18 = global %[[STRUCT_S14]] zeroinitializer, align 1
// CHECK: @gs19 = global ptr ptrauth (ptr @gs18, i32 1, i64 104), align 8
// CHECK: @gs20 = global %[[STRUCT_S13]] zeroinitializer, align 1
// CHECK: @gs21 = global ptr ptrauth (ptr @gs20, i32 2, i64 105), align 8
...
// CHECK: call i32 @__cxa_atexit(ptr ptrauth (ptr @_ZN2S0D1Ev, i32 0), ptr ptrauth (ptr @gs0, i32 1, i64 100), ptr @__dso_handle)
// CHECK: ret void
// CHECK: }
...
// CHECK: %[[F1:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[V9]], i32 0, i32 1
...
// CHECK: %[[F1:.*]] = getelementptr inbounds nuw %[[STRUCT_S3]], ptr %[[V14]], i32 0, i32 1
...
// CHECK: invoke void @__cxa_throw(ptr %exception, ptr @_ZTI2S0, ptr ptrauth (ptr @_ZN2S0D1Ev, i32 0))
...
// CHECK: %[[F1:.*]] = getelementptr inbounds nuw %[[STRUCT_S0]], ptr %[[S0]], i32 0, i32 1
...
// CHECK: %[[THIS1:.*]] = load ptr, ptr %[[THIS_ADDR]], align 8
// CHECK: %[[V1:.*]] = getelementptr inbounds nuw %[[CLASS_ANON]], ptr %[[REF_TMP]], i32 0, i32 0
// CHECK: store ptr %[[THIS1]], ptr %[[V1]], align 8
// CHECK: %[[V2:.*]] = getelementptr inbounds nuw %[[CLASS_ANON]], ptr %[[REF_TMP]], i32 0, i32 1
...
// CHECK: %[[THIS1:.*]] = load ptr, ptr %[[THIS_ADDR]], align 8
// CHECK: %[[V1:.*]] = getelementptr inbounds nuw %[[CLASS_ANON_0]], ptr %[[REF_TMP]], i32 0, i32 0
// CHECK: %[[V2:.*]] = ptrtoint ptr %[[V1]] to i64
...
// CHECK: %[[V5:.*]] = getelementptr inbounds nuw %[[CLASS_ANON_0]], ptr %[[REF_TMP]], i32 0, i32 1
...
// CHECK: store ptr %[[THIS]], ptr %[[THIS_ADDR]], align 8
// CHECK: %[[THIS1:.*]] = load ptr, ptr %[[THIS_ADDR]], align 8
// CHECK: %[[V0:.*]] = getelementptr inbounds nuw %[[CLASS_ANON]], ptr %[[THIS1]], i32 0, i32 0
...
// CHECK: %[[V8:.*]] = getelementptr inbounds nuw %[[CLASS_ANON]], ptr %[[THIS1]], i32 0, i32 1
...
// CHECK: store ptr %[[THIS]], ptr %[[THIS_ADDR]], align 8
// CHECK: %[[THIS1:.*]] = load ptr, ptr %[[THIS_ADDR]], align 8
// CHECK: %[[V0:.*]] = getelementptr inbounds nuw %[[CLASS_ANON_0]], ptr %[[THIS1]], i32 0, i32 0
// CHECK: %[[V1:.*]] = ptrtoint ptr %[[V0]] to i64
// CHECK: %[[V2:.*]] = call i64 @llvm.ptrauth.sign(i64 %[[V1]], i32 1, i64 100)
// CHECK: %[[V3:.*]] = inttoptr i64 %[[V2]] to ptr
...
// CHECK: %[[V10:.*]] = getelementptr inbounds nuw %[[CLASS_ANON_0]], ptr %[[THIS1]], i32 0, i32 1
