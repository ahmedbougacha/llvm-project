...
// CHECK: [[CAPTURE_SLOT:%.*]] = getelementptr inbounds nuw <{ ptr, i32, i32, ptr, ptr, ptr }>, ptr %block1, i32 0, i32 5
// CHECK: [[HANDLER:%.*]] = load ptr, ptr %handler.addr
...
// CHECK: [[CAPTURE_SLOT:%.*]] = getelementptr inbounds nuw <{ ptr, i32, i32, ptr, ptr, ptr }>, ptr %block8, i32 0, i32 5
// CHECK: [[HANDLER:%.*]] = load ptr, ptr %handler.addr
// CHECK: store ptr [[HANDLER]], ptr [[CAPTURE_SLOT]]
    asm volatile("");
}
