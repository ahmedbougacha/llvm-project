...
// CHECK: @fptr1 = global ptr ptrauth (ptr @external_function, i32 0, ptr null, i64 18983)
void (*fptr1)(void) = external_function;
// CHECK: @fptr2 = global ptr ptrauth (ptr @external_function, i32 0, ptr null, i64 18983)
void (*fptr2)(void) = &external_function;

// CHECK: @fptr3 = global ptr ptrauth (ptr @external_function, i32 2, ptr null, i64 26)
void (*fptr3)(void) = __builtin_ptrauth_sign_constant(&external_function, 2, 26);

// CHECK: @fptr4 = global ptr ptrauth (ptr @external_function, i32 2, ptr @fptr4, i64 26)
...
// CHECK:  ret ptr ptrauth (ptr @external_function, i32 0, ptr null, i64 18983)
...
void use_while_incomplete() {
  ...
  // NOPCH-NEXT: store ptr ptrauth (ptr @returns_initially_incomplete, i32 0, ptr null, i64 25106), ptr [[VAR]]
  // PCH:        [[VAR:%.*]] = alloca ptr,
  // PCH-NEXT:   store ptr ptrauth (ptr @returns_initially_incomplete, i32 0, ptr null, i64 25106), ptr [[VAR]]
...
void use_while_complete() {
  ...
  // CHECK-NEXT: store ptr ptrauth (ptr @returns_initially_incomplete, i32 0, ptr null, i64 25106), ptr [[VAR]]
  // CHECK-NEXT: ret void
  struct InitiallyIncomplete (*fnptr)(void) = &returns_initially_incomplete;
}
