...
// CHECK: @_unnamed_cfstring_ = private global %struct.__NSConstantString_tag { ptr ptrauth (ptr @__CFConstantStringClassReference, i32 2, ptr @_unnamed_cfstring_, i64 27361), i32 1992, ptr @.str, i64 13 }, section "__DATA,__cfstring"
// CHECK: @.str.1 = private unnamed_addr constant [7 x i8] c"yo joe\00", section "__TEXT,__cstring,cstring_literals", align 1
// CHECK: @_unnamed_cfstring_.2 = private global %struct.__NSConstantString_tag { ptr ptrauth (ptr @__CFConstantStringClassReference, i32 2, ptr @_unnamed_cfstring_.2, i64 27361), i32 1992, ptr @.str.1, i64 6 }, section "__DATA,__cfstring"
...
// CHECK: @_unnamed_cfstring_.4 = private global %struct.__NSConstantString_tag { ptr ptrauth (ptr @__CFConstantStringClassReference, i32 2, ptr @_unnamed_cfstring_.4, i64 27361), i32 1992, ptr @.str.3, i64 15 }, section "__DATA,__cfstring"
