...
// CXX: store ptr getelementptr inbounds (i32, ptr ptrauth (ptr @f, i32 0, ptr null, i64 0), i64 2), ptr @_ZL2fp, align 8
...
void t1() {
  // CHECK: [[PF:%.*]] = alloca ptr
  // CHECK: store ptr getelementptr inbounds (i32, ptr ptrauth (ptr @f, i32 0, ptr null, i64 0), i64 2), ptr [[PF]]
