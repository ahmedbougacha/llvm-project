...
// CHECK: @ptr1 = global ptr ptrauth (ptr @external, i32 0, ptr null, i64 26)
void *ptr1 = __builtin_ptrauth_sign_constant(&external, 0, 26);

// CHECK: @ptr2 = global ptr ptrauth (ptr @external, i32 2, ptr @ptr2, i64 26)
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    store ptr ptrauth (ptr @external, i32 2, ptr null, i64 1234), ptr @ptr3, align 8
// CHECK-NEXT:    ret void
