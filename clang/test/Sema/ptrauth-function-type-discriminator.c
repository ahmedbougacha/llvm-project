// RUN: %clang_cc1 %s -triple arm64-apple-darwin -fptrauth-intrinsics -verify -xobjective-c -fblocks
// RUN: %clang_cc1 %s -triple arm64-apple-darwin -fptrauth-intrinsics -verify -xc
// RUN: %clang_cc1 %s -triple arm64-apple-darwin -fptrauth-intrinsics -verify -xc++
